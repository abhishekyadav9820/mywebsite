  ...
  return (
    <div>
            ...
            <div className="col-md-6 mt-5">
              <div className="servicePageText">
                ...
                <ul className="mt-3">
                  <li>
                    <p>
                      The concept of treating an aging male collectively brings
                      in a new era both from preventive and therapeutic aspect.
                      In this concept, the role of Testosterone (hormones) has
                      been elaborated. These hormones are just not responsible
                      for sex drive and sexual performance but they also help
                      build protein, keep the bones strong, and play a role in
                      metabolic activities.
                    </p>
                  </li>
                  <li>
                    <p>This concept could elaborate multi
                      specialty problems in aging male. This may reflect as
                      sexual dysfunction, enlargement of prostate, cancer of
                      prostate, osteoporosis, phylogenic depression, cardiac
                      dysfunctions.</p>
                  </li>
            ...
            <div className="col-md-6 mt-3">
              ...
              <div className="servicePageText">
                <ul>
                  <li>
                    <p>
                      It is at this juncture in life, a man over the age of 50
                      years has to take preventive measures for Erectile
                      Dysfunction, smooth passage of urine, to rule out early
                      development of prostate cancer, endocrinological disorders
                      and prevent cardiac dysfunctions
                    </p>
                  </li>
                </ul>
              </div>
      ...
      <section className="serviceDetails">
        <h2 className="serviceCeterTittle">Give Aging men a chance</h2>
          ...
          <div className="row d-flex justify-content-center align-items-center">
            <div>
              <ol>
                <li>
                  <p>
                    Aging is inevitable but graceful aging and accepting certain
                    problems and preventing others has become an important part
                    in the management of aging population.
                  </p>
                </li>
                <li>
                  <p>
                    Our goal is to ensure that the specific health needs of Men
                    are given greater attention than ever before, specially for
                    the following reasons. These are also the facts, which make
                    health professionals all over the world speak of a "crisis
                    in men's health":
                    <ul>
                      <li>
                        Male life expectancy is unnecessarily low and too many
                        men die too young from preventable causes.
                      </li>
                      <li>
                        The incidence of men's disease (CA prostate and
                        testicular cancer) is rapidly increasing.
                      </li>
                      <li>
                        Men are especially at risk for suicide, yet male
                        depression remains under-diagnosed and under treated.
                      </li>
                      <li>
                        Sexual health problems (including Erectile Dysfunction)
                        are common.
                      </li>
                      <li>
                        Health services have been slow to respond to men's
                        health needs. Little has been done to encourage and
                        enable men to access overall services more quickly and
                        effectively.
                      </li>
                    </ul>
                  </p>
      ...
      <section style={{ backgroundColor: "aliceblue" }} className="servicePageSection">
        <div className="container">
          <div className="row">
            <div className="servicePageText">
              <h2>Treatment at "Aging Male Clinic"</h2>
              <p>
                To tackle the problems of Elderly Male in a comprehensive
                manner, Dr. Raja’s Urology & Andrology Center will look into the
                following fields in their new concept of “aging male Clinic“ The
                motto is "Bridging the Gap - The Male Patient in your Daily
                Practice" reflecting the center's integrative approach for
                combining for the first time, the knowledge of practicing
                Urologist & Andrologist and General practitioner in a more
                interdisciplinary way, focusing on the practical issues of Men's
                Health in day to day Medical Practice.
              </p>
              <ol className="mt-3">
                <li>
                  <p>Erectile Dysfunction & Male Sexual Health</p>
                </li>
                <li>
                  <p>Voiding Dysfunction in Men (BPH) </p>
                </li>
                <li>
                  <p>
                    Cancer in Males (CA Prostate) - Prevention, Diagnosis &
                    Treatment.
                  </p>
                </li>
                <li>
                  <p>Endocrinological manifestations</p>
                </li>
                <li>
                  <p>Male Cardiovascular Disease</p>
                </li>
                <li>
                  <p>Male Mood Disorder - from anger to depression</p>
                </li>
                <li>
                  <p>Osteoporosis in men</p>
                </li>
                <li>
                  <p>Male Puberty / obesity</p>
                </li>
                <li>
                  <p>Communication with male patients</p>
                </li>
              </ol>
            </div>
          </div>
