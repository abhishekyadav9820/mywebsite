...
import "../CSS/Page.css";
import image2 from "../Image/bloodUrine.jpg";
import image3 from "../Image/Blood in Urine/urine.jpg";
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6">
              ...
              <p>Why do we get blood in the urine?</p>
            </div>
            <div className="col-md-6" />
          </div>
        </div>
      ...
      <section className="servicePageSection">
        <div className="container">
          <div className="row">
            <div className="col-md-6 mt-5">
              <div className="servicePageText">
                <h2>Why do we get blood in the urine?</h2>
                <h2>Causes:</h2>
                <ol className="mt-3">
                  <li>
                    <p>Cancer of the Kidney, Ureter, Bladder or prostate</p>
                  </li>
                  <li>
                    <p>Polycystic Kidney Disease</p>
                  </li>
                  <li>
                    <p>Medical Renal Disease Amidst many other causes.</p>
                  </li>
                </ol>
              </div>
              <div className="servicePageText pt-5">
                ...
                <ol className="mt-3">
                  ...
                  <li>
                    <p>Plenty of Liquid intake orally</p>
                  </li>
                </ol>
              </div>
            </div>
          ...
          <div className="col-12 d-flex justify-content-center align-items-center">
            <div className="servicePageText pt-5">
              <p>
                Any blood in urine must be thoroughly investigated and the
              ...
              {/* <div className="servicePageImg1">
                 <img src={image3} alt="About company" />
               </div> */}
            </div>
          </div>
        </div>
